...
void loop() {
  ...
  digitalWrite(BUZZER_PIN, sensor_value > 40 ? HIGH : LOW); // activate buzzer if the line was not detected
  digitalWrite(LED_PIN, sensor_value <= 40 ? HIGH : LOW); // activate LED if the line was detected
  delay(200);
}
